...
/**
 * SECURITY: Gets GitHub token from request body (passed from client session)
 * 
...
export async function getGitHubToken(req: Request): Promise<GitHubProfile | null> {
  try {
    ...
    // Get GitHub token from request body (passed from client)
    const body = await req.json();
    const githubToken = body.provider_token;

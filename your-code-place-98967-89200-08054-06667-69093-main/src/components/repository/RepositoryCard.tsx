        ...
        <CardHeader>
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-2">
              <GitBranch className="h-6 w-6 sm:h-5 sm:w-5 text-primary" />
              {repo.private ? (
                <Lock className="h-5 w-5 sm:h-4 sm:w-4 text-muted-foreground" />
              ) : (
                <Globe className="h-5 w-5 sm:h-4 sm:w-4 text-muted-foreground" />
              )}
            </div>
            <div className="flex items-center gap-1">
              <Button
                ...
                onClick={handleStar}
              >
                <Star className={`h-5 w-5 sm:h-4 sm:w-4 ${isStarred ? 'fill-yellow-400 text-yellow-400' : ''}`} />
              </Button>
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  <DropdownMenuItem onClick={() => onSettings(repo)}>
                    <Settings className="h-5 w-5 sm:h-4 sm:w-4 mr-2" />
                    Settings
                  </DropdownMenuItem>
